...
LDOS_opt, ε_opt, LDOS_vals, omegas, _, _ = optimizer_2d(Lx, Ly, ε_init, ω, b; resolution=res, ftol=0, max_eval=500000, design_dimensions=(3,3), fR=0.2, β=Inf)
